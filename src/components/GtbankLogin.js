...
function GtbankLogin(props) {
  ...
  return (
    <div className="bg-gtbank rounded-custom px-7.5 pt-10 pb-36 overflow-hidden shadow-xl transform transition-all sm:max-w-sm sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
      <div>
        ...
        <div className="mt-6 text-left sm:mt-6">
          <h3 className="text-4xl leading-10 font-black text-white" id="modal-headline">
